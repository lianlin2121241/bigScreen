$.fn.commonscroll = function(opations) {
    var defaults = {
    ...
    return function() {
        ...
        //获取元素
        var panelH=settings.picElem.height();
        ...
        function creatArrows() {
            var arrowTop=0-(panelH-50)/2
            var $arrowsHtml = '<span class="arrow prev" style="top:'+arrowTop+'px"><</span><span class="arrow next" style="top:'+arrowTop+'px">></span>';
